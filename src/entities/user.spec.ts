...
describe('user domain class', () => {
  test('should not create user with invalid e-mail address', async () => {
    ...
    const error = User.create({ name: 'any_name', mail: invalidEmail }).value as Error
  ...
  test('should not create user with invalid name (too few characters)', () => {
    const invalidName = 'O'
    const error = User.create({ name: invalidName, mail: 'any@mail.com' }).value as Error
  ...
  test('should create user with valid data', () => {
    ...
    const user: User = User.create({ name: validName, mail: validEmail }).value as User
